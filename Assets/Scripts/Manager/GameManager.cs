...
public class GameManager : Singleton<GameManager>
{
    ...
    void Start()
    {
        addItemButton.onClick.AddListener(()=>{ UIManager.Instance.CreatePanel(EnumType.UIPanel.PnlNewItem, UIManager.Instance.TopCanvas); });
        btnSettings.onClick.AddListener(()=>{ UIManager.Instance.CreatePanel(EnumType.UIPanel.PnlSettings, UIManager.Instance.TopCanvas); });
